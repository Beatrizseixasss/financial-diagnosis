...
import { Menu, Target, TrendingUp, Users, X } from "lucide-react";
...
function MarketingPage({ onStartDiagnostic, totalXP }: { onStartDiagnostic: () => void; totalXP: number }) {
    return (
        <main>
                    ...
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                Ganhe XP, suba de nível, e desbloqueie badges enquanto constrói hábitos financeiros
                                melhores. <strong className="text-foreground">Sem economês. Sem julgamento.</strong>
                            </p>
                        ...
                        <div className="space-y-3">
                            <div className="coin-card rounded-xl border border-border bg-card p-6">
                                <div className="coin-card-header">
                                    ...
                                    <span className="coin-xp">{totalXP.toLocaleString("pt-BR")} XP</span>
                                </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        <Card className="border-border">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Cada ação financeira saudável te aproxima do próximo nível. Veja seu progresso em
                                    tempo real.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="border-border">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Comece com desafios fáceis e avance para objetivos mais ambiciosos conforme você
                                    evolui.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="border-border">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Suba posições na nossa ranking justa, baseada em consistência, crescimento e
                                    engajamento.
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        <Card className="border-border">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Entenda sua relação com dinheiro em 6 perguntas rápidas.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="border-border">
                        ...
                        <Card className="border-border">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Ganhe XP e compita com a comunidade de forma justa.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
            ...
            <header className="sticky top-0 z-50 border-b border-border bg-background/60 backdrop-blur-lg">
                <div className="container mx-auto flex items-center justify-between px-6 py-4">
                    ...
                    <nav className="hidden items-center gap-6 md:flex">
                        ...
                        <a href="#desafios" className="text-muted-foreground transition-colors hover:text-foreground">
                            Desafios
                        </a>
                    </nav>
...
export default function FinFitLanding() {
    ...
    useEffect(() => {
        try {
            ...
            if (raw) {
                ...
                if (!Number.isNaN(parsed)) setTotalXP(parsed);
            }
        } catch (e) {
            // ignore
        }
        ...
        const handler = (ev: Event) => {
            try {
                ...
                if (typeof detail === "number") setTotalXP(detail);
                else {
                    const raw = localStorage.getItem("finfit_user_xp");
                    if (raw) {
                        const parsed = parseInt(raw, 10);
        ...
        window.addEventListener("finfit-xp-changed", handler as EventListener);
        return () => window.removeEventListener("finfit-xp-changed", handler as EventListener);
    }, []);
    ...
    const handleCompleteActivity = (activity: Activity) => {
        ...
        setTotalXP(prevXP => {
            const newXP = prevXP + activity.xp;
            try {
    ...
    if (showDiagnostic) {
        return (
            <DiagnosticFlow onBack={() => setShowDiagnostic(false)} onDiagnosticComplete={handleDiagnosticComplete} />
        );
    }
    ...
    return (
        <div className="min-h-screen">
            ...
            <MarketingPage onStartDiagnostic={() => setShowDiagnostic(true)} totalXP={totalXP} />
                ...
                <div className="container mx-auto px-6 py-12">
                    <div className="grid gap-8 md:grid-cols-3">
                        ...
                        <nav className="flex flex-col gap-2">
                            <a href="#recursos" className="text-sm text-muted-foreground">
                                Recursos
                            </a>
                            <a href="#como-funciona" className="text-sm text-muted-foreground">
                                Como Funciona
                            </a>
                            <a href="#ranking" className="text-sm text-muted-foreground">
                                Ranking
                            </a>
                        </nav>
                        <div>
